...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("fluxion_encoding", .{
    ...
    const example_mod = b.createModule(.{
        ...
        .target = target,
        .optimize = optimize,
        .imports = &.{.{ .name = "fluxion_encoding", .module = mod }},
    });
    const example = b.addExecutable(.{
        .name = "fluxion-encoding-demo",
